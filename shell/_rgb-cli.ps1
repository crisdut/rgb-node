...
Register-ArgumentCompleter -Native -CommandName 'rgb-cli' -ScriptBlock {
    ...
    $completions = @(switch ($command) {
        ...
        'rgb-cli;transfer' {
            ...
            [CompletionResult]::new('bifrost', 'bifrost', [CompletionResultType]::ParameterValue, 'Validate incoming transfer consignment and consume it into the stash')
            [CompletionResult]::new('accept', 'accept', [CompletionResultType]::ParameterValue, 'accept and reveal transfer consignment')
            [CompletionResult]::new('help', 'help', [CompletionResultType]::ParameterValue, 'Print this message or the help of the given subcommand(s)')
            break
        }
